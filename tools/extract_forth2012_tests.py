...
F12_OVERRIDES = {
    ...
    "op-d-dot.yml": "Dd",
    "op-d-two-div.yml": "DTwoDiv",
    "op-d-two-times.yml": "DTwoTimes",
    ...
    "op-div.yml": "Div",
    "op-div-string.yml": "DivSTRING",
    "op-mul.yml": "Times",
    "op-two-div.yml": "TwoDiv",
    "op-two-times.yml": "TwoTimes",
    "op-u-dot.yml": "Ud",
    "op-u-greater.yml": "Umore",
    "op-um-times.yml": "UMTimes",
